...
import { DoradcaConfig } from '../components/DoradcaConfig'
...
export function Doradca() {
  ...
  const cfg = useLoanStore((s) => s.doradcaCfg)
  const setCfg = useLoanStore((s) => s.setDoradcaCfg)
      ...
      <div className="rounded-lg border bg-white p-6 shadow-sm">
        ...
        {data && (
          <div className="mt-6 flex flex-col gap-6">
            ...
            <DoradcaTable result={data} showTargetCol={cfg.hasTarget} targetMonths={targetMonths} />
          </div>
        )}
      </div>
    </div>
